  ...
  return (
    <div className="relative flex min-h-[calc(100svh-10vh)] md:min-h-[91dvh] items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative bg-zinc-900/40 backdrop-blur-sm p-6 rounded-lg shadow-md w-full max-w-sm text-white z-10">
        <img src="/alfa-chat-logo-lowres.webp" className='p-3 w-[6rem] rounded-3xl mx-auto' alt="logo" loading='lazy' />
        <h1 className="text-2xl font-semibold mb-4 text-center">Alfa Chat</h1>

        <label className="block mb-2 text-sm text-gray-300">Enter your Username</label>
        <input
          type="text"
