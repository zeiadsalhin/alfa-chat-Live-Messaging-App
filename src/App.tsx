...
// Main App component that sets up the routing and connection status, It uses React Router for navigation and Socket.IO for real-time communication, i18n support, also includes a fixed banner for server offline status and adjusts the layout accordingly
...
function App() {
  ...
  return (
    <Middleware>
      ...
      {!isChatPage && <Footer t={t} i18n={i18n} />}
    </Middleware>
  );
}
